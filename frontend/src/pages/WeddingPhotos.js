  ...
  render() {
    ...
    return (
      <Container fluid>
        ...
        <p className="text-center d-md-none">Photos are courtesy of <a href="https://www.instagram.com/haleyjane.photography/" target="_blank" rel="noopener noreferrer">Haley Jane Photography</a></p>
        <p className="text-center d-md-none subHeader"><a href="https://haleyjanephotography.com/" target="_blank" rel="noopener noreferrer">haleyjanephotography.com</a></p>
